...
This service is intentionally self-contained and does NOT import from
app.models.database (the broken sibling-project module).  All persistence
that matters for the demo is kept in-memory; the EmergencyRequest SQLAlchemy
row is written by the Flask route layer.
"""
